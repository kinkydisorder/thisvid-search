...
const SimpleSearch = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      setProgressMsg(`Iniciando extracción de ${pagesToScrape} páginas en paralelo...`);
  ...
  const inSidebar = activePlayerVideo !== null;
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'sans-serif', maxWidth: '1200px', margin: '0 auto', minHeight: '100vh', backgroundColor: '#1a1a1a', color: '#e0e0e0' }}>
      ...
      {/* Player and Grid rendering selected or searched videos */}
      <div style={{
        display: 'flex',
